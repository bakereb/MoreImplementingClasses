...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.reverse_identity = 0
        self.slope_of_line = 0
        self.number_of_clones = 0
        self.start_initial = start.clone()
        self.end_initial = end.clone()
    ...
    def reverse(self):
        ...
        self.reverse_identity = self.start
        self.start = self.end
        self.end = self.reverse_identity
    ...
    def slope(self):
        ...
        if self.end.x - self.start.x == 0:
            ...
            self.slope_of_line = (self.end.y - self.start.y) / (self.end.x - self.start.x)
            return self.slope_of_line
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        line_final = Line(self.start.plus(other_line.start), self.end.plus(other_line.end))
        return line_final
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        line_final = Line(self.start.minus(other_line.start), self.end.minus(other_line.end))
        return line_final
    ...
    def is_parallel(self, line2):
        ...
        ################################################################
        slope_a = round(self.slope(), 12)
        slope_b = round(line2.slope(), 12)
        if slope_a == slope_b:
            return True
        else:
            return False
    ...
    def reset(self):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        self.start = self.start_initial
        self.end = self.end_initial
